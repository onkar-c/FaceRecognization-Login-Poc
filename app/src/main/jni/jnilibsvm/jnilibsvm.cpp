...
Java_com_example_facerecognization_1poc_wrapper_LibSVM_jniSvmTrain(JNIEnv *env, jobject instance,
																   jstring cmdIn) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_facerecognization_1poc_wrapper_LibSVM_testLog(JNIEnv *env, jobject instance,
															   jstring logThis) {
...
JNIEXPORT void JNICALL
Java_com_example_facerecognization_1poc_wrapper_LibSVM_jniSvmPredict(JNIEnv *env, jobject obj,
																	 jstring cmdIn, jobject buf,
																	 jint len) {
	const char *cmd = env->GetStringUTFChars(cmdIn, 0);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_facerecognization_1poc_wrapper_LibSVM_jniSvmScale(JNIEnv *env, jobject instance,
																   jstring cmdIn,
																   jstring fileOutPathIn) {
	const char *cmd = env->GetStringUTFChars(cmdIn, 0);
